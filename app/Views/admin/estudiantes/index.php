<?= $this->extend('admin/template/layout');
    ...
    $this->section('encabezado') ?><p class="text-uppercase">Estudiantes</p><?= $this->endSection();
                        ...
                        if (count($usuarios) > 0):
                            foreach ($usuarios as $usuario): ?>
                                <tr>
                                    ...
                                    <td><?= $usuario['sexo'] ?></td>
                                    <td class="d-flex">
                                        <a href="<?= base_url('admin/estudiantes/'.$usuario['id']) ?>" class="btn btn-sm btn-info mx-1" title="Ver"><i class="bi bi-info-square"></i></a>
                                        <a href="<?= base_url('admin/estudiantes/'.$usuario['id'].'/edit') ?>" class="btn btn-sm btn-success mx-1" title="Editar"><i class="bi bi-pencil-square"></i></a>
                                        <form class="display-none" method="post" action="<?= base_url('admin/estudiantes/'.$usuario['id'])?>" id="usuarioDeleteForm<?=$usuario['id']?>">
